...
knn_rmse_plot_350 + annotate(geom="text", x=6, y=18000, label= paste("Optimal k-value = ", toString(optimal_k_350)), color="red") 
...
knn_rmse_plot_65AMG = ggplot(data = knn_rmse_65AMG) +
  ...
  xlab("k-value") +
  ylab("Root Mean Square Error")
knn_rmse_plot_65AMG + annotate(geom="text", x=20, y=60000, label= paste("Optimal k-value = ", toString(optimal_k_65AMG)), color="red") 
...
p_test_350 = ggplot(data = D_test_350) + 
  ...
  labs(title = "Optimal KNN model, 350", subtitle = paste("k = ", toString(optimal_k_350)), x = "Mileage", y = "Price ($)")
p_test_350
...
p_test_65AMG = ggplot(data = D_test_65AMG) + 
  ...
  labs(title = "Optimal KNN model, 65 AMG", subtitle = paste("k = ", toString(optimal_k_65AMG)), x = "Mileage", y = "Price ($)")
p_test_65AMG
```

As shown above, the optimal k-value for 
