...
news<-read_csv("Desktop/Data Mining/Homework/DataScienceCourseHomework/Exercises-2/data/online_news.csv")
news$url<- NULL
```
...
```{r sample confusion matrix, message=FALSE, warning=FALSE}
confusion_out_logit
```
...
```{r baseline nonviral matrix,  results = 'asis'}
...
```{r log of shares matrix over 100 reps,  results = 'asis'}
...
```{r logit model confusion matrix averages, results = 'asis'}
